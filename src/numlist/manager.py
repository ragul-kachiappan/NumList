...
class NumberListManager:
    ...
    def get_numbers_with_timestamps(self) -> list[dict[str, int | str]]:
        ...
        with sqlite3.connect(self.db_file) as conn:
            ...
            return [{"number": row[0], "added_at": row[1]} for row in cursor.fetchall()]
    ...
    def get_db_info(self) -> dict[str, str | int | bool]:
    ...
    def export_to_csv(
        self, output_file: str | Path, include_timestamps: bool = False
    ) -> bool:
    ...
    def export_to_pickle(self, output_file: str | Path) -> bool:
